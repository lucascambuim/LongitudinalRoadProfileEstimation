...
class KalmanF
{
	...
	public:
		...
		KalmanF(cv::Mat stateVectorInit_d, double covarianceOfStateVectorInitScalar, double processNoiseScalar, double measurementNoiseScalar, double baseWidth, double focalLength, int imageRows, int imageColumns);
